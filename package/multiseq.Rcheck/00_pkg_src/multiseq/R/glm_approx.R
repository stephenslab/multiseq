...
#' @export
#' @keywords internal
#' @return a matrix of 2 (or 5 if g is provided, including the covariance parameter between intercept and slope) by B (# of WCs); each row contains alphahat (1st row), standard error of alphahat (2nd), and in addition (if g is provided), betahat (3rd), standard error of betahat (4th), covariance between alphahat and betahat (5th) for each WC.
